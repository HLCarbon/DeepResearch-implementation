...
To use local LLM, comment out `OPENROUTER_KEY` and instead uncomment `OPENROUTER_ENDPOINT` and `OPENROUTER_MODEL`:
- Set `OPENROUTER_ENDPOINT` to the address of your local server (eg."http://localhost:1234/v1")
- Set `OPENROUTER_MODEL` to the name of the model loaded in your local server.
